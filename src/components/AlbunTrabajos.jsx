    ...
    return (
        <>
            ...
            <div className="text-center my-5"> {/* Centrado y margen vertical */}
                <NavLink to={'https://www.facebook.com/pintordurleronahuel/photos_albums'} target="_blank" className="btn btn-dark btn-lg text-uppercase fw-bold shadow">Ver más en Facebook</NavLink> {/* Estilo de botón oscuro, grande, mayúsculas, bold y sombra */}
            </div>
        </>
    )
}